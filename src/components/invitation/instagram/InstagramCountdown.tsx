...
interface InstagramCountdownProps {
  targetDateISO: string;
}

export default function InstagramCountdown({ targetDateISO }: InstagramCountdownProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 select-none space-y-2 pt-2">
      {/* Subtitle & Title above card */}
      <div className="space-y-0.5">
        <p className="text-[11px] font-mono font-extrabold tracking-widest uppercase">
          <span className="text-[#E4405F]">HITUNG </span>
          <span className="text-[#833AB4]">MUNDUR</span>
        </p>
      ...
      <div className="bg-[#121212] border border-zinc-800 rounded-2xl p-4 sm:p-5 shadow-xl space-y-4 relative overflow-hidden">
        ...
        <div className="flex items-center gap-1.5">
          <div className="flex-1 h-0.5 bg-white/90 rounded-full" />
          <div className="flex-1 h-0.5 bg-white/90 rounded-full" />
          <div className="flex-1 h-0.5 bg-white/90 rounded-full" />
          <div className="flex-1 h-0.5 bg-white/90 rounded-full" />
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pt-1">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3 sm:gap-5 text-white font-sans">
              ...
              {/* Seconds */}
              <div className="text-center">
                <span className="text-3xl sm:text-4xl md:text-5xl font-extrabold font-sans tracking-tight text-[#E4405F]">
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0">
            <a
              ...
              className="flex items-center gap-1.5 bg-[#222222] hover:bg-[#E4405F] text-white text-xs font-bold px-3.5 py-2 rounded-xl border border-zinc-700/80 transition-all shadow"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-[#222222] hover:bg-[#E4405F] text-white text-xs font-bold px-3.5 py-2 rounded-xl border border-zinc-700/80 transition-all shadow"
            >
              <CalendarIcon className="w-3.5 h-3.5 text-zinc-300" />
              <span>Outlook</span>
            </a>
